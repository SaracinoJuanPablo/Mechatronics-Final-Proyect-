...
UDP_OPEN = '0.0.0.0'
UDP_PORT_SERVO = 5001  # Puerto para controlar el servomotor
UDP_PORT_CAM = 5002  # Puerto para recibir video

# Crear sockets UDP
send_sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
receive_sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
receive_sock.bind((UDP_OPEN, UDP_PORT_CAM))
                    ...
                    if results.multi_hand_landmarks and results.multi_handedness:
                        ...
                        for idx, hand_handedness in enumerate(results.multi_handedness):
                            ...
                            if hand_handedness.classification[0].label == 'Left': #como lo detecta espejado usamos la mano izq
                                ...
                                send_sock.sendto(str(x_normalized).encode(), (UDP_IP_PI, UDP_PORT_SERVO))
