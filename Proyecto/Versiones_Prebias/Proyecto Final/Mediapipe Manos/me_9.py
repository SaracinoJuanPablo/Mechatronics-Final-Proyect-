...
class SignLanguageSystem:
    ...
    def collect_data(self):
        ...
        while True:
            ...
            if results.multi_hand_landmarks:
                ...
                if len(landmarks) in [21, 42]:  # Asegurarse de que se detectaron una o ambas manos
    ...
    def train_model(self):
        ...
        if len(X) == 0 or len(y) == 0:
            print("\nNo hay datos válidos para entrenar el modelo.")
            return
        ...
        while True:
            ...
            if results.multi_hand_landmarks:
                for hand_landmarks in results.multi_hand_landmarks:
                    ...
                    # Reproducir el nombre del gesto si la confianza es mayor al 80% y la predicción ha cambiado
