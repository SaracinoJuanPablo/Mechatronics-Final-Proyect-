...
def procesar_comandos():
    ...
    try:
            ...
            for sock in rlist:
                if sock == command_sock:
                    ...
                    try:
                        ...
                        elif command_str.startswith("MOVE_SERVO:"):
                            try:
                                angle = int(command_str.split(":")[1])
                                ...
                                print(f"Error en formato de ángulo: {e}")
                                command_sock.sendto(b"ERROR", addr)
                        else:
                            # Si el comando es un número directo (para seguimiento)
                            try:
        ...
        print(f"Error crítico en procesamiento de comandos: {e}")
    finally:
