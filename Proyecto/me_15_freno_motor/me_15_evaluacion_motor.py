...
hands_detected_status = False#HASTRACA
...
def extract_hand_landmarks(frame, send_sock=None):
    ...
    #NUEVO Enviar estado de detección
    ...
    if hands_detected:
        ...
        if current_time - last_hands_detected_time > 2:  # Esperar 2 segundos sin manos
            sock_hands_status.sendto(b"NO_HANDS", (UDP_IP_PI, UDP_PORT_HANDS_STATUS))
            hands_detected_status = False#ASHASRTA
