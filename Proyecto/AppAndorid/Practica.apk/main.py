...
class Calculadora(App):
    ...
    def operacion(self, data):
        try:
            ...
            self.root.pantalla.text = 'ERROR' #ERROR
        except ZeroDivisionError:
            self.root.pantalla.text = 'NO SE PUEDE DIVIDIR ENTRE CERO' #NO SE PUEDE DIVIDIR ENTRE CERO
        except  TypeError:
            self.root.pantalla.text = '(2)(2)  x' # (2)(2)  x 
